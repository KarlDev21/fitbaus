...
import {
  BaseScreen,
  NavStackScreenDefinitions,
} from './StackNavigationContainer';
...
export const navigationRefUnauthenticated =
  createNavigationContainerRef<UnauthenticatedScreenDefinitions>();
export const navigationRefAuthenticated =
  createNavigationContainerRef<AuthenticatedScreenDefinitions>();
